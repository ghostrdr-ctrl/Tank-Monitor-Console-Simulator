...
; No spaces in the file name. GitHub rewrites spaces to dots in a release
; asset, so a spaced name is displayed as "Tank.Monitor...Setup.exe" while
; SHA256SUMS.txt records the spaced name it was built with -- and a
; technician comparing the two by eye sees a mismatch that is not real.
OutputBaseFilename=TankMonitorConsoleSimulator-{#MyAppVersion}-Setup
